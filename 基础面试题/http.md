##### 1. HTTP2和HTTP1有什么区别
[HTTP1.0、1.1、2.0对比优缺点详解（长链接、缓存、错误码增加、断点续传、Host优化、身份认证、多路复用、二进制分帧、报文压缩、服务端推送）](https://blog.csdn.net/XJ5210224/article/details/127557117)
...
##### TCP、UDP的区别？
[TCP、UDP的区别](https://www.php.cn/faq/463414.html)
